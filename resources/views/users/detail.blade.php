            ...
            <div class="row">
                <div class="col-lg-4 col-xl-4">
                    <div class="card text-center">
                        <div class="card-body">
                            <?php 
                            if(count($avatarUsers[$user[0]['id']]) > 0){
                                foreach($avatarUsers[$user[0]['id']] as $avatar) {
                                    ?>
                                    <img src="<?php echo $avatar->getFullUrl(); ?>" class="rounded-circle avatar-xl img-thumbnail"
                                    alt="profile-image">
                                    <?php 
                                }
                            } else {
                                ?>
                                <img src="/assets/images/users/avatar-basic.jpg" class="rounded-circle avatar-xl img-thumbnail"
                                alt="profile-image">
                                <?php
                            }
                            ?>

                            <h4 class="mt-3 mb-0"><?php echo $user[0]['name']; ?></h4>
                                    ...
                                    <table class="table table-borderless table-sm">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-muted"><?php echo $user[0]['name']; ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Mobile :</th>
                                                <td class="text-muted"><?php echo $user[0]['phone']; ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Email :</th>
                                                <td class="text-muted"><?php echo $user[0]['email']; ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Location :</th>
                                                <td class="text-muted"><?php echo $user[0]['country']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="lastname" value="<?php echo $user[0]['name'] ?>">
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="email" class="form-control" id="useremail" value="<?php echo $user[0]['email'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="social-fb" value="<?php echo $user[0]['facebook'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
