                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="text-center card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-3 mb-1"><a href="{{ route('user.detail', $value['id']) }}" class="text-dark"><?php echo $value['name']?></a></h4>
                                <p class="text-muted">@Role <span> | </span> <span> <a href="{{ route('user.detail', $value['id']) }}" class="text-pink"><?php echo $value['user_role']['name']?></a> </span></p>
                    ...
                    <div class="float-sm-end">
                        <ul class="pagination pagination-rounded mb-sm-0">
                            <li class="page-item <?php ($currentPage == 1) ? 'disabled' : '' ?> ">
                                <a href="{{ route('user.page',$currentPage - 1) }}" class="page-link"><i class="mdi mdi-chevron-left"></i></a>
                            </li>
                            <?php 
                            for($i = 1; $i <= $numPage; $i++){
                                if ($currentPage == $i) {
                            ...
                            <li class="page-item <?php ($currentPage == $numPage) ? 'disabled' : '' ?>">
                                <a href="{{ route('user.page', $currentPage + 1) }}" class="page-link"><i class="mdi mdi-chevron-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
